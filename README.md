Bamazon is a project utilizing Node.js and MySQL.  The goal was to create a vitual storefront, like a simplified version of the real Amazon.com store front. 
